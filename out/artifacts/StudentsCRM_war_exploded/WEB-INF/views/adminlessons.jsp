...
<div class="main_wrap" style="background-color: #FFFFFF;">
    ...
    <table>
        ...
        <tr>
            <td>
                <h4><%out.print(n); %>. Название: <%out.print(lesson.getTitle()); %></h4><br>
                <h4>Предмет: <%out.print(lesson.getCourse().getName()); %></h4><br>
                <h5>Контент: <%out.print(lesson.getContent()); %></h5><br>
            </td>
            <td>
                <center>
